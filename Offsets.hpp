...
namespace OW {
	namespace offset {
		static constexpr auto Address_viewmatrix_base = 0x3E68248; //viewmatrix xor
		static constexpr auto Address_viewmatrix_base_test = 0x3F20DE8; //viewmatrix
		static constexpr auto Address_entity_base = 0x36696D0; //entityadmin
		...
		static constexpr auto changefov = 0x3C36088; //myFOV
		...
		static constexpr auto SensitivePtr = 0x2180;
